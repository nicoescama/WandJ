...
class ClassificationTsvReader(DatasetReader):
    ...
    def _read(self, datalist) -> Iterable[Instance]:
        datalistjson = json.loads(datalist)
        for line in datalistjson:
            text = line['short_description']
            sentiment = line['category']
...
def run_training_loop():
    ...
    # batching code.
    train_loader, dev_loader, test_loader = build_data_loaders(train_data, dev_data, test_data)
